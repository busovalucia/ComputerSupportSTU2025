...
Data: The **msleep** (mammals sleep) data set contains the sleeptimes and weights for a set of mammals. It is part of the **ggplot2** package. This data set contains `r nrow(msleep)` rows and `r ncol(msleep)` variables.
